...
import { OperationType, Streamdal } from "../streamdal.js";
const exampleData = {
    boolean_t: true,
    boolean_f: false,
    object: {
...
const logTest = (streamdal, audience, input) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    console.log(`sending pipeline request for ${audience.serviceName} - ${OperationType[audience.operationType].toLowerCase()}`);
...
export const exampleStaggered = () => __awaiter(void 0, void 0, void 0, function* () {
...
// eslint-disable-next-line @typescript-eslint/require-await
export const tailFriendly = () => __awaiter(void 0, void 0, void 0, function* () {
    const streamdalA = new Streamdal(serviceAConfig);
    const streamdalB = new Streamdal(serviceBConfig);
...
// eslint-disable-next-line @typescript-eslint/require-await
export const highVolumeTail = () => __awaiter(void 0, void 0, void 0, function* () {
    const streamdalA = new Streamdal(serviceAConfig);
    const streamdalB = new Streamdal(serviceBConfig);
    setInterval(() => {
        void logTest(streamdalA, audienceAConsumer, exampleData);
...
// eslint-disable-next-line @typescript-eslint/require-await
export const throughputFriendly = () => __awaiter(void 0, void 0, void 0, function* () {
    const streamdalA = new Streamdal(serviceAConfig);
    const streamdalB = new Streamdal(serviceBConfig);
    void randomInterval(streamdalA, audienceAConsumer, exampleData);
...
// eslint-disable-next-line @typescript-eslint/require-await
export const tailFast = () => __awaiter(void 0, void 0, void 0, function* () {
    const streamdalB = new Streamdal(serviceBConfig);
    setInterval(() => {
        void logTest(streamdalB, audienceBConsumer, exampleData);
    }, 100);
...
// eslint-disable-next-line @typescript-eslint/require-await
export const exampleConcurrent = () => __awaiter(void 0, void 0, void 0, function* () {
    const streamdalA = new Streamdal(serviceAConfig);
    const streamdalB = new Streamdal(serviceBConfig);
    setInterval(() => {
        void logTest(streamdalA, audienceAConsumer, exampleData);
...
// eslint-disable-next-line @typescript-eslint/require-await
export const exampleMultipleGroup = () => __awaiter(void 0, void 0, void 0, function* () {
    const streamdalA = new Streamdal(serviceAConfig);
    const streamdalB = new Streamdal(serviceBConfig);
    void logTest(streamdalA, audienceAConsumer, exampleData);
    void logTest(streamdalA, Object.assign(Object.assign({}, audienceAConsumer), { operationName: "kafka-consumer-two" }), exampleData);
...
// eslint-disable-next-line @typescript-eslint/require-await
export const exampleMultipleComponentsPerService = () => __awaiter(void 0, void 0, void 0, function* () {
    const streamdalA = new Streamdal(serviceAConfig);
    const streamdalB = new Streamdal(serviceBConfig);
    void logTest(streamdalA, audienceAConsumer, exampleData);
    void logTest(streamdalA, Object.assign(Object.assign({}, audienceAConsumer), { componentName: "another-kafka" }), exampleData);
...
// eslint-disable-next-line @typescript-eslint/require-await
export const exampleSimple = () => __awaiter(void 0, void 0, void 0, function* () {
    const streamdalA = new Streamdal(serviceAConfig);
    void logTest(streamdalA, audienceAConsumer, exampleData);
});
