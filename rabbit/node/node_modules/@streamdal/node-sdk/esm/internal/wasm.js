...
const wasi = new WASI(Object.assign(Object.assign({}, (Number(nodeVersionMajor) >= 20 ? { version: "preview1" } : {})), { preopens: {
        "/sandbox": "./",
    } }));
export const readResponse = (pointer, buffer) => {
    let nullHits = 0;
    const data = [];
...
export const runWasm = ({ step, data, }) => __awaiter(void 0, void 0, void 0, function* () {
